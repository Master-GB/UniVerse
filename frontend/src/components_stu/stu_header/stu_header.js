                    ...
                    <div className={`stu-nav-links ${isOpen ? 'stu-active' : ''}`}>
                        ...
                        <div className="stu-dropdown">
                            ...
                            <div className="stu-dropdown-content">
                                <Link to="/student/academic-resources" className="stu-dropdown-item">
                                    Academic Resources
                                </Link>
                                <Link to="/student/career-resources" className="stu-dropdown-item">
                                    Career Resources
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="stu-dropdown">
                            ...
                            <div className="stu-dropdown-content">
                                <Link to="/student/academic-session" className="stu-dropdown-item">
                                    Academic Session
                                </Link>
                                <Link to="/student/career-session" className="stu-dropdown-item">
                                    Career Session
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="stu-user-menu">
                        <button className="stu-notification-btn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 2C10.9 2 10 2.9 10 4V4.29C7.12 5.14 5 7.83 5 11V17L3 19V20H21V19L19 17V11C19 7.83 16.88 5.14 14 4.29V4C14 2.9 13.1 2 12 2ZM12 6C14.76 6 17 8.24 17 11V18H7V11C7 8.24 9.24 6 12 6Z" fill="currentColor"/>
                                <path d="M12 23C13.1 23 14 22.1 14 21H10C10 22.1 10.9 23 12 23Z" fill="currentColor"/>
                            </svg>
