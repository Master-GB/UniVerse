...
function CourseContent() {
  ...
  const handleVideoComplete = (index) => {
    ...
    if (index === currentVideoIndex && index < course.videos.length - 1) {
      setCurrentVideoIndex(prev => prev + 1);
    }
  };
...
Explore a variety of courses designed to inspire learning and growth. Each course offers structured content, practical insights, and engaging activities to help you develop valuable skills and expand your knowledge at your own pace        </div>
        <h3>Video Lessons</h3>
      ...
      <div className="course-content-section-coursecontent">
        <h1 className="course-details-title-coursecontent">{course.name}  Course Content</h1>
        ...
        <div className="details-buttons-coursecontent">
          <button className="course-btn-cou-coursecontent" onClick={() => navigate(-1)}>
            Back
          </button>
        </div>
      </div>
